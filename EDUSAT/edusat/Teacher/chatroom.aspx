            ...
            <div style="background-color: #4bdd91; height: 100%;">
                ...
                <div style="width: 450px; height: 100%; border: 2px solid #0094ff; border-radius: 5px; float: left">
                    <table>
                        <tr >
                            <td colspan="2">
                                 <asp:Panel ID="Panel1" runat="server" ScrollBars="Vertical" Height="550px" Width="430px">
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        ...
                        <tr>
                            <td>
                                  <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control" Height="32px" Width="350px"></asp:TextBox>
                            </td>
                            <td>
