                    ...
                    <td>&nbsp;<tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control" MaxLength="10" TextMode="Phone"></asp:TextBox>
                                <br />
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="Label11" runat="server" CssClass="control-label" Text="Course"></asp:Label>
                            </td>
                            <td>
